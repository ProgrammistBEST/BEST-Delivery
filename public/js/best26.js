...
async function allModel() {
    let responce = await fetch('/getModelBest26',
        {
            method: 'POST'
        });
    ...
    document.querySelector('.btn-create').addEventListener('click', function () {
        ...
        if (checkedTrue.length != 0) {
            if (document.querySelector('.checked-model') == null) {
                ...
                const jsonUrl1 = 'jsonModel/best26-model.json';
                    ...
                    if (sendObj.length == document.querySelectorAll('.row-model').length) {
                        ...
                        fetch('/createOrderBest26',
                            ...
                            .then(data => {
                                ...
                                a.download = "Best26 файлы поставки.zip";
                                setTimeout(() => {
                                    main.innerHTML = `
                                    ...
                                    main.innerHTML =
                                        ...
                                        `
                                    setTimeout(() => {
                                        // window.location.replace("/best26");
                                    }, 6000)
                                }, 1000);
                            });
                    }
