...
async function allModel() {
    let responce = await fetch('/getModelArmbest',
        {
            method: 'POST'
        });
    ...
    let index = 0
    let del_mod = [
        '12-бордовый', '12-фиолетовый', '12-синий', '12-черный', '26-бордовый', '26-синий',
        '36/черный', '37-black', '063-5', '063-1', '063-8', '063-2', '071-1', '071-8', '071-7', '071', '076-1', '076-7', '076-2', '076', '076-12',
        '076-10', '081-2', '081-1', '081', '082-1', '082', '082-2', '085-1',
        '085-2', '085', '087-2', '087-1', '087', '089', '089-3',
        '089-1', '091-5', '091-6', '091-10', '091-11', '091-2', '091-8', '091-4', '091-3', '091-7',
        '092-4', '092-10', '092-2', '092-3', '092-6', '092-7', '092-11', '092-8', '095-7', '095-5',
        '095-8', '095-1', '095-3', '095-6', '095-10', '095-2', '095-11', '095-4', '600-бордовый',
        '600-камуфляж', '602-бордовый', '602-камуфляж', '700-бордовый', '700-камуфляж', '702-бордовый',
        '702-камуфляж', '063-7', '063-6'
    ]
    ...
    document.querySelector('.btn-create').addEventListener('click', function () {
        ...
        if (checkedTrue.length != 0) {
            if (document.querySelector('.checked-model') == null) {
                ...
                const jsonUrl1 = 'jsonModel/armbest-model.json';
                ...
                async function fetchAndCompareJson() {
                    try {
                        ...
                        if (!response1.ok) throw new Error('Ошибка при загрузке armbest-model.json');
                    ...
                    if (sendObj.length == document.querySelectorAll('.row-model').length) {
                        ...
                        fetch('/createOrderArmbest',
                            ...
                            .then(data => {
                                ...
                                a.download = "Armbest файлы поставки.zip";
                                setTimeout(() => {
                                    main.innerHTML = `
